...
export default function MessageItem({ message, onDelete }) {
  ...
  return (
    ...
    >
      <span
        className={`absolute right-0 top-0 translate-x-[60%] translate-y-[-60%] px-2 rounded-full cursor-pointer opacity-0 ${
      ...
      <div
        className={`h-full w-full absolute top-0 left-0 bg-gray-50 flex flex-col justify-center items-center rounded-lg ${
